...
export default {
    ...
    setup(props){
        const { getProvider, provider, updateProvider, errors } = useProviders();

        onMounted(getProvider(props.id));

        const saveProvider = async () => {
            await updateProvider(props.id);
        }
