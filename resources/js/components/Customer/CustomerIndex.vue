    ...
    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
      <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200" v-for="customer in filteredList" :key="customer.id">
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <router-link :to="{name: 'customers.edit', params: { id: customer.id }}" class="px-2 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-700"> Modifier </router-link >
